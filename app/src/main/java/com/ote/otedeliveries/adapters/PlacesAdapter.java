...
public class PlacesAdapter extends ArrayAdapter {
    private static final String TAG = PlacesAdapter.class.getCanonicalName();

    private List<Place> dataList;
    private Context context;

    private PlacesAdapter.PlacesAutoCompleteFilter listFilter = new PlacesAdapter.PlacesAutoCompleteFilter();
    ...
    public class PlacesAutoCompleteFilter extends Filter {
        ...
        private Task<AutocompletePredictionBufferResponse> getAutoCompletePlaces(String query) {
            ...
            return geoDataClient.getAutocompletePredictions(query, null, filterBuilder.build());
        }
    }
}