...
public class OteRecyclerView extends RecyclerView {
    ...
    public OteRecyclerView(Context context) {
        super(context);
        this.context = context;
    }

    public OteRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public OteRecyclerView(Context context, AttributeSet attrs, int defStyle) {
