...
public class PhotoPickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, final PickerOptionListener listener, String title){
        ...
        // add a list
        String[] options = {context.getString(R.string.take_from_camera), context.getString(R.string.choose_from_gallery)};
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(PhotoPickerActivity.this, getPackageName() + ".provider", image);
    }
